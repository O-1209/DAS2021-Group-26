...
```{r points.vs.price1,out.width='80%',fig.align="center",fig.cap = "\\label{fig:box1} The boxplot of points against price"}
...
The above boxplots \ref{fig:box1} show that higher-priced wines are of higher quality, in general, compared to the lower-priced wines and there is not overlap between "Good" and "Excellent". The prices of wines are widely distributed. There are also potentially some outliers which have quite high price, as shown by the points shown beyond the “whiskers” of the boxplots.

```{r points.vs.price2,out.width='80%',fig.align="center",fig.cap = "\\label{fig:box2} The boxplot of points against price"}
#scatter plot
...
From the figure \ref{fig:scat}, we can more intuitively see that the prices of good wines are mostly concentrated in the range of 0-50, while the prices of excellent wines are higher and more widely distributed.
