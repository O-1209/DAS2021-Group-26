...
From the Importance analysis of variables plot, obviously, `price` and `country` have a greater influence on the `points`, especially `price`, whose RMSE of price is greater than 0.5. However, the `year` and other variables's RMSE are almost close to 0, which means that the varibles excepting from `price` and `country` have few impact on the `points`. 
